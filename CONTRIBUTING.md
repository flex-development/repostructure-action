...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/rice-action
   cd rice-action
   ```
...
```sh
https://github.com/flex-development/rice-action/compare/main...$branch
```
...
[19]: https://github.com/flex-development/rice-action/discussions/new?category=q-a
